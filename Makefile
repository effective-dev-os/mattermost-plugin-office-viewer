...
ifneq ($(HAS_SERVER),)
	...
	mockgen -destination=server/command/mocks/mock_commands.go -package=mocks github.com/effective-dev-os/mattermost-plugin-office-viewer/server/command Command
endif
